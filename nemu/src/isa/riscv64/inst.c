...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  // INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw , R, R(dest) = SEXT((sword_t)BITS(src1, 31, 0) >> BITS(src2, 4, 0), 32));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw , R, R(dest) = SEXT((sword_t)BITS(src1, 31, 0) >> BITS(src2, 4, 0), 64));
