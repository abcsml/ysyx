...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00000 11", lb     , I, R(dest) = SEXT(Mr(src1 + src2, 1), 64));    // 64???
  INSTPAT("??????? ????? ????? 001 ????? 00000 11", lh     , I, R(dest) = SEXT(Mr(src1 + src2, 2), 64));
  INSTPAT("??????? ????? ????? 010 ????? 00000 11", lw     , I, R(dest) = SEXT(Mr(src1 + src2, 4), 64));
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu   , I, R(dest) = SEXT(Mr(src1 + src2, 1), 64)); // test
  INSTPAT("??????? ????? ????? 101 ????? 00000 11", lhu   , I, R(dest) = SEXT(Mr(src1 + src2, 2), 64));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli   , I, R(dest) = src1 >> BITS(src2, 5, 0));
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = (sword_t)src1 >> (sword_t)BITS(src2, 5, 0));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw , R, R(dest) = SEXT(src1 << BITS(src2, 4, 0), 64));   // 64???
