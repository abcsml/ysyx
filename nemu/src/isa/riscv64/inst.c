...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00110 11", sraiw , I, R(dest) = SEXT((sword_t)BITS(src1, 31, 0) >> (sword_t)BITS(src2, 4, 0), 32));   // ????
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw , R, R(dest) = SEXT(BITS(src1, 31, 0) << BITS(src2, 4, 0), 32));  // SEXT 截断为32位
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw , R, R(dest) = SEXT(BITS(src1, 31, 0) >> BITS(src2, 4, 0), 32));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw , R, R(dest) = SEXT((sword_t)BITS(src1, 31, 0) >> (sword_t)BITS(src2, 4, 0), 32));
