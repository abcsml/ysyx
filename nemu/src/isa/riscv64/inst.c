...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slliw , I, R(dest) = SEXT(src1 << BITS(src2, 4, 0), 32));
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srliw , I, R(dest) = SEXT(src1 >> BITS(src2, 4, 0), 32));
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", sraiw , I, R(dest) = SEXT((sword_t)src1 >> (sword_t)BITS(src2, 4, 0), 32));
