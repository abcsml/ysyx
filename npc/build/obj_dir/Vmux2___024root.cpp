...
VL_INLINE_OPT void Vmux2___024root___combo__TOP__1(Vmux2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux2___024root___combo__TOP__1\n"); );
    // Body
...
QData Vmux2___024root___change_request_1(Vmux2___024root* vlSelf);

VL_INLINE_OPT QData Vmux2___024root___change_request(Vmux2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux2___024root___change_request\n"); );
    // Body
    return (Vmux2___024root___change_request_1(vlSelf));
}

VL_INLINE_OPT QData Vmux2___024root___change_request_1(Vmux2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux2___024root___change_request_1\n"); );
    // Body
    // Change detection
